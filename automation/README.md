...
2. Set `AI_CMD` to your local AI runner command that reads the prompt from STDIN (e.g. `your-ai-cli --non-interactive`). For safety, this repo does not include a default AI runner; keep your command in `.env` or a local wrapper script.
